...
$sqle = "UPDATE nominees_c8 SET full_name='$cname', facebook='$facebook', weblink='$weblink', email='$email2' WHERE id = '$id'";
    $conn->query($sqle);
    
    $sqle = "UPDATE shortlisted_c8 SET full_name='$cname', facebook='$facebook', weblink='$weblink', email='$email2' WHERE full_name = '$cname'";
    $conn->query($sqle);

    $sqls = "SELECT * FROM nominees_c8 WHERE id=$id";
    

if($sqle){

  $conn->close();
  header('location: nominees888.php');
}
