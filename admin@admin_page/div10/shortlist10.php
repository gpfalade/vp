...
$sqls = "SELECT * FROM nominees_c10 WHERE full_name='$shortlist1'";
...
$sht = "CREATE TABLE IF NOT EXISTS shortlisted_c10 (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
$shtq = "INSERT INTO shortlisted_c10(id, full_name, facebook, weblink, email) VALUES ('', '$cname', '$facebook', '$weblink', '$email2')";
$conn->query($shtq);
...
<script>location.href='nominees101010.php';</script>
