...
$sqltable2 = "CREATE TABLE IF NOT EXISTS nominees_c10 (
...
$sqlc = "INSERT INTO nominees_c10(id, full_name, facebook, weblink, email) VALUES ('', '$cname', '$facebook', '$weblink', '$email2')";
$conn->query($sqlc);
        ...
        <section id="container" >
            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="row">
<?php
echo "<h1><b>" . $_SESSION['div10'] . "</b></h1>";
echo "<h2><u>Nominees</u></h2>";
require '../../configure.php';
?>
<a href="http://localhost/vp/admin@admin_page/div10/addnominee10.php" class="btn btn-success">Add new nominee</a>
<?php
$sqls = "SELECT * FROM nominees_c10 ORDER BY full_name";
...
if($result = $conn->query($sqls)){
    if($result->num_rows > 0){?>
        ...
        <tr>
            ...
            <td><a href="edit10.php?id=<?php echo $row[0];?>" onClick="return confirm('Are you sure you want to edit this candidate\'s details?')" class="btn btn-warning">Edit</a></td>
            <td><a href="delete10.php?nominee=<?php echo $row[1];?>" onClick="return confirm('Are you sure you want to delete this candidate from the nominee list?')" class="btn btn-danger">Delete</a></td>
            <td><a href="shortlist10.php?nominee=<?php echo $row[1];?>" onClick="return confirm('Are you sure you want to shortlist this candidate for voting?')" class="btn btn-success">Shortlist</a></td>
        </tr>
        </tbody>
        <?php } ?>
    </table>
