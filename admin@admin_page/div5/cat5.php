            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="form_div">
                        ...
                        <fieldset>
                        <legend><h1>Edit name for category 5</h1></legend>

                        <label for="div1">Category name</label>
                        <input type="text" id="div5" name="div5" value="" placeholder="Insert category name here..." required/>

                        <input class="submit" type="submit" value="Submit" name="submitc5"/>
                        </fieldset>
                        </form>
                    </div>
