            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="form_div">
                        ...
                        <fieldset>
                        <legend><h1>Edit name for category 9</h1></legend>

                        <label for="div1">Category name</label>
                        <input type="text" id="div9" name="div9" value="" placeholder="Insert category name here..." required/>

                        <input class="submit" type="submit" value="Submit" name="submitc9"/>
                        </fieldset>
                        </form>
                    </div>
