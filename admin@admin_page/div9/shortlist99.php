...
$sqls = "SELECT * FROM shortlisted_c9";
...
if($result = $conn->query($sqls)){
    if($result->num_rows > 0){?>
        ...
        <tr>
            ...
            <td> <a href="remove9.php?nominee=<?php echo $row[1]; ?>" onClick="return confirm('Are you sure you want to remove this candidate from the shortlisted list?')" class="btn btn-danger">Remove</a></td>
          </tr>
        </tbody>
        <?php } ?>
    </table>
