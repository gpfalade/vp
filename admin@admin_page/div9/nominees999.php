...
?>
<a href="http://localhost/vp/admin@admin_page/div9/addnominee9.php" class="btn btn-success">Add new nominee</a>
<?php
...
if($result = $conn->query($sqls)){
    if($result->num_rows > 0){?>
        ...
        <tr>
            ...
            <td><a href="edit9.php?id=<?php echo $row[0];?>" onClick="return confirm('Are you sure you want to edit this candidate\'s details?')" class="btn btn-warning">Edit</a></td>
            <td><a href="delete9.php?nominee=<?php echo $row[1];?>" onClick="return confirm('Are you sure you want to delete this candidate from the nominee list?')" class="btn btn-danger">Delete</a></td>
            <td><a href="shortlist9.php?nominee=<?php echo $row[1];?>" onClick="return confirm('Are you sure you want to shortlist this candidate for voting?')" class="btn btn-success">Shortlist</a></td>
        </tr>
        </tbody>
        <?php } ?>
    </table>
