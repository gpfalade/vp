            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="form_div">
                        ...
                        <fieldset>
                        <legend><h1>Edit name for category 6</h1></legend>

                        <label for="div1">Category name</label>
                        <input type="text" id="div6" name="div6" value="" placeholder="Insert category name here..." required/>

                        <input class="submit" type="submit" value="Submit" name="submitc6"/>
                        </fieldset>
                        </form>
                    </div>
