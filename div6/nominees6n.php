...
if(isset($_POST['submit2'])){
    ...
    header('location: http://localhost/vp/div6/nominees66.php');
    exit();
}
...
if($result = $conn->query($sqls)){
    if($result->num_rows > 0){?>
        ...
        <tr>
            ...
            <td><a href="nominate6.php?nominee=<?php echo $row[1];?>" class="btn btn-success">Nominate</a></td>
        </tr>
        </tbody>
        <?php } ?>
        </table>
...
<body>
<a href="http://localhost/vp/div6/decoyaddnominee6.php" onClick="return confirm('This means you could not find your desired nominee on the list?')" class="class" id="add">Add new nominee</a>
</br>
<br>
</body>
</html>