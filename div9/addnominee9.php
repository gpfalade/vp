...
if(isset($_POST['submit1'])){
  if(($_POST['yname'] != "") && (preg_match("/^[a-zA-Z\s\-\_]+$/", $_POST['yname']))){
    ...
    header('location: http://localhost/vp/div9/decoyaddnominee9.php');
  }
...
$sqltable1 = "CREATE TABLE IF NOT EXISTS nominations_c9 (
  id INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
  full_name VARCHAR(90) NOT NULL,
  email VARCHAR(100) NOT NULL,
  phone VARCHAR(20) NOT NULL,
...
$sqln = "INSERT INTO nominations_c9(id, full_name, email, phone, dates) VALUES ('', '$yname', '$email1', '$phone', '$dates')";
$conn->query($sqln);
$conn->close();
?>
...
<div class="container">
  <form action="nominees9n.php" method="POST">
      <fieldset>
