...
if(isset($_POST['submit1'])){
  if(($_POST['yname'] != "") && (preg_match("/^[a-zA-Z\s\-\_]+$/", $_POST['yname']))){
    ...
    header('location: http://localhost/vp/div4/decoyvote4.php');
  }
...
$sqltable1 = "CREATE TABLE IF NOT EXISTS voters_c4 (
  id INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
  full_name VARCHAR(90) NOT NULL,
  email VARCHAR(100) NOT NULL,
  phone VARCHAR(20) NOT NULL,
...
$sqln = "INSERT INTO voters_c4(id, full_name, email, phone, dates) VALUES ('', '$yname', '$email1', '$phone', '$dates')";
$conn->query($sqln);
?>
...
$sqls = "SELECT id, full_name FROM shortlisted_c4";

if($result = $conn->query($sqls)){
    if($result->num_rows > 0){?>
    <div class="form_div">
    <form action="decoyvote44.php" method="POST">
    <?php
