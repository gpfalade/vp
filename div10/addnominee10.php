...
if(isset($_POST['submit1'])){
  if(($_POST['yname'] != "") && (preg_match("/^[a-zA-Z\s\-\_]+$/", $_POST['yname']))){
    ...
    header('location: http://localhost/vp/div10/decoyaddnominee10.php');
  }
...
$sqltable1 = "CREATE TABLE IF NOT EXISTS nominations_c10 (
  id INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
  full_name VARCHAR(90) NOT NULL,
  email VARCHAR(100) NOT NULL,
  phone VARCHAR(20) NOT NULL,
...
<div class="container">
  <form action="nominees10n.php" method="POST">
      <fieldset>
